...
class FormPage(BasePage):
    ...
    def fill_fields_and_submit(self):
        ...
        self.element_is_visible(Locators.MOBILE).send_keys('5466554555')
        ...
        self.element_is_visible(Locators.FILE_INPUT).send_keys(r'D:\Python\Django\qa_example_python\text.txt')
